...
\author{Justin Raišp \\ {\small Mentor: Matej Rojec}}
\date{20. januar 2026}
...
\begin{frame}{Pravila igre in mehanika izplačil}
    ...
    \begin{itemize}
        ...
        \item Izplačila se izračunajo kot $\frac{\text{Stava} \times \text{Množitelj simbola}}{\text{Število plačilnih linij}}$
    \end{itemize}
    \begin{figure}
        \centering
    ...
    \begin{figure}
        \centering
          \begin{minipage}{0.45\textwidth}
            ...
            \caption{Dobljeni bonus s 3 scatter simboli.}
        \end{minipage}
        \hfill
        \begin{minipage}{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{Figures/freespins.png}
            \caption{Primer vrtljaja v bonus igri.}
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}{Simulacije}
    \begin{itemize}
        ...
        \item \textbf{Analiza rezultatov:}
            ...
            \end{itemize}
    \end{itemize}
    Studentova porazdelitev: $\frac{\bar{X}-\mu}{S/\sqrt{n}}$
    \\
    95\% interval zaupanja: $\left[\bar{x} -\frac{c \cdot S}{\sqrt{n}}, \bar{x} +\frac{c \cdot S}{\sqrt{n}}\right],$ kjer $c \approx 1.96.$
\end{frame}
...
\begin{frame}{Zaključek}
    ...
    \begin{itemize}
        ...
        \item Ustvarjanje uporabniškega vmesnika za boljšo izkušnjo.
    \end{itemize}
\end{frame}
